...
class Seq2SeqTransformer(nn.Module):
    def __init__(self,
        ...
        self.positional_encoding = PositionalEncoding(
            emb_size, dropout=dropout, maxlen=max_length)
    ...
    def greedy_decode(self, src: Tensor, src_mask:Tensor, max_len: int, start_symbol: int, device: torch.device):
        src = src.to(device)
    ...
    def translate(self, src: torch, trg_vocab: Vocab, device: torch.device):
        self.eval()
